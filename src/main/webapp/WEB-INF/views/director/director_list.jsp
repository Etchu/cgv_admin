...
<head>
	...
	<script src="/resources/js/director.js"></script>
</head>
<body>
		...
		<div class="inside_wrap">
					...
					<c:forEach items="${list}" var="list">
						<div>
							<ul class="list_content">
								<li class="list_seq">${list.cmd_seq}</li>
								<li class="list_name">${list.cmd_name}</li>
								<li class="list_reg_date"><fmt:formatDate value="${list.cmd_reg_date}" pattern="yyyy-MM-dd HH:mm"/></li>
			...
			<div class="actor_add_modal">
				<div class="modal_content">
					<h1><span>감독 추가</span></h1>
					<div class="input_row">
						<p>이름</p>
						<input type="text" id="actor_name" placeholder="감독 명을 입력하세요"/>
<!-- 						<p>내용</p>
