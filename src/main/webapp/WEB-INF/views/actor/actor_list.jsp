...
<head>
	...
	<script src="/resources/js/actor.js"></script>
</head>
<body>
		...
		<div class="inside_wrap">
					...
					<c:forEach items="${list}" var="list">
						<div>
							<ul class="list_content">
								<li class="list_seq">${list.cma_seq}</li>
								<li class="list_name">${list.cma_name}</li>
								<li class="list_reg_date"><fmt:formatDate value="${list.cma_reg_date}" pattern="yyyy-MM-dd HH:mm"/></li>
			...
			<div class="actor_add_modal">
				<div class="modal_content">
					<h1><span>배우 추가</span></h1>
					<div class="input_row">
						<p>이름</p>
						<input type="text" id="actor_name" placeholder="배우 명을 입력하세요"/>
<!-- 						<p>내용</p>
