...
<head>
	...
	<script src="/resources/js/add_movie.js"></script>
</head>
<body>
		...
		<div class="inside_wrap">
			...
			<div class="content_wrap">
				...
				<div class="sub_title_area">
					<span>소 제목</span>
					<input type="text" id="movie_sub_title"/>
				</div>
				
				<div class="open_date">
					<span class="item_title">개봉일</span>
					<input type="text" id="open_expire_date"/>	
				</div>
			
				<div class="time_area">
					<span>상영시간</span>
					<input type="text" id="movie_running"/>
				</div>
				
				<div class="country_area">
					<span>제작나라</span>
					<input type="text" id="make_country"/>
				</div>
				...
				<div class="content_area">
					<span>내용</span>
					<textarea id="movie_content"></textarea>
				</div>
				...
				<div class="sel_movie_grade select_area">
					<span>영화 등급</span>
					<div>
					<input type="radio" name="sel_movie_grade" class="sel_movie_grade" id="grade_all" value="1"/>
					<label for="grade_all" id="grade_all_text">전체 관람가</label>
				
					<input type="radio" name="sel_movie_grade" class="sel_movie_grade" id="grade_twelve" value="2"/>
					<label for="grade_twelve" id="grade_twelve_text">12세 관람가</label>
				
					<input type="radio" name="sel_movie_grade" class="sel_movie_grade" id="grade_fifteen" value="3"/>
					<label for="grade_fifteen" id="grade_fifteen_text">15세 관람가</label>
				
					<input type="radio" name="sel_movie_grade" class="sel_movie_grade" id="grade_limit" value="4"/>
					<label for="grade_limit" id="grade_limit_text">청소년 관람불가</label>
				
					<input type="radio" name="sel_movie_grade" class="sel_movie_grade" id="grade_undefined" value="5"/>
				...
				<div class="btn_area">
        	    	<button id="movie_save">등록</button>
